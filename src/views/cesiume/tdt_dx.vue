...
export default {
  ...
  created() {},
  mounted() {
    console.log(Cesium, 'in this Cesium')
    this.$nextTick(() => {
      this.initMap()
    })
  },
  methods: {
    initMap() {
      var token = '828cde706b224a702d36b8e713566d05'
      // 服务域名
      ...
      viewer.camera.setView({
        destination: new Cesium.Cartesian3(153897.11561229284, 7466983.723739154, 150000),
        orientation: {
